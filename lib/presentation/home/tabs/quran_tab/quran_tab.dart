...
import 'package:quran_app/presentation/home/tabs/quran_tab/widgets/quran_tab_header_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Expanded(
            flex: 1,
            child: Center(child: Image.asset(AssetsManger.quranHeaderImage))),
